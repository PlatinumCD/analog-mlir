...
*/
extern "C" Tensor2DF32 analog_run_layer_2d_from_3d_2d(
...
/*
  ...
  signature (3D, 2D) -> 2D. Completion is synchronized via
...
/*
  ...
  (3D, 2D) -> 2D have completed and returns the resulting rank-2 tensor.
*/
