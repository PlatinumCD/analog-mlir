...
/*
  ...
  rank-2 tensor operand and writes its rank-2 result into the provided
  memref-style output buffer. Completion is synchronized via
...
/*
  ...
  Asynchronously dispatches a generated single-input layer routine with a
  rank-3 tensor operand and writes its rank-3 result into the provided
  memref-style output buffer. Completion is synchronized via
...
/*
  ...
  Asynchronously dispatches a generated single-input layer routine with a
  rank-4 tensor operand and writes its rank-4 result into the provided
  memref-style output buffer. Completion is synchronized via
...
/*
  ...
  Asynchronously dispatches a generated single-input layer routine with a
  rank-5 tensor operand and writes its rank-5 result into the provided
  memref-style output buffer. Completion is synchronized via
