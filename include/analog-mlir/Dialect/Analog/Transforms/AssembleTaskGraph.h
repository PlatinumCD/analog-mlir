#ifndef ANALOG_MLIR_DIALECT_ANALOG_TRANSFORMS_ASSEMBLETASKGRAPH_H
#define ANALOG_MLIR_DIALECT_ANALOG_TRANSFORMS_ASSEMBLETASKGRAPH_H
...
struct AssembleTaskGraphPass
  ...
  mlir::StringRef getArgument() const final {
    return "analog-assemble-task-graph";
  }
...
#endif // ANALOG_MLIR_DIALECT_ANALOG_TRANSFORMS_ASSEMBLETASKGRAPH_H
