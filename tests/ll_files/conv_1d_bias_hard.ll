module {
  func.func @forward(%arg0: tensor<1x1x6xf32>) -> tensor<1x3x4xf32> {
    ...
    %cst_0 = arith.constant dense_resource<torch_tensor_3_1_3_torch.float32> : tensor<3x1x3xf32>
    %0 = tensor.empty() : tensor<1x3x4xf32>
    %broadcasted = linalg.broadcast ins(%cst : tensor<3xf32>) outs(%0 : tensor<1x3x4xf32>) dimensions = [0, 2] 
    %1 = linalg.conv_1d_ncw_fcw {dilations = dense<1> : vector<1xi64>, strides = dense<1> : vector<1xi64>} ins(%arg0, %cst_0 : tensor<1x1x6xf32>, tensor<3x1x3xf32>) outs(%broadcasted : tensor<1x3x4xf32>) -> tensor<1x3x4xf32>
