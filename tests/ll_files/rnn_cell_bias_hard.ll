...
module {
  func.func @forward(%arg0: tensor<1x4xf32>, %arg1: tensor<1x3xf32>) -> tensor<1x3xf32> {
    ...
    ^bb0(%in: f32, %in_5: f32, %out: f32):
      %10 = arith.addf %in, %in_5 : f32
      linalg.yield %10 : f32
    } -> tensor<1x3xf32>
    %5 = tensor.empty() : tensor<4x3xf32>
    %transposed_4 = linalg.transpose ins(%cst_2 : tensor<3x4xf32>) outs(%5 : tensor<4x3xf32>) permutation = [1, 0] 
    %6 = linalg.matmul ins(%arg0, %transposed_4 : tensor<1x4xf32>, tensor<4x3xf32>) outs(%2 : tensor<1x3xf32>) -> tensor<1x3xf32>
...
{-#
  dialect_resources: {
    builtin: {
      ...
      torch_tensor_3_torch.float32: "0x0400000000004040000080400000A040",
      ...
      torch_tensor_3_torch.float32_1: "0x04000000000000000000803F00000040"
    }
  }
#-}
